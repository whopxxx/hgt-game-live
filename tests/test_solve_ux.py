...
def ident_spec(completion=("f1", "f2"), core="门外女人是父亲的亲生女儿。"):
    ...
    return _stamp_beats(PuzzleSpec(
        ...
        prompt_version="riddle-v9", quality_policy_version="quality-v10"))
...
def test_closeout_b2_v5_must_have_contract():
    ...
    check("版本常量确实是 v9", _Q == "quality-v10", _Q)
...
def test_v6_pool_quarantines_quality_v5():
    ...
    ok2, why2 = PuzzlePool._validate_pool_spec(_full("quality-v10"))
    check("quality-v10 完整题 -> 入池", ok2, why2)
