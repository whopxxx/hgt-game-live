...
from story.quality import (MAX_COMPLETION_FACTS, QUALITY_POLICY_VERSION,
                           validate_spec)  # noqa: E402
...
def test_closeout_b2_v5_must_have_contract():
    ...
    check("版本常量确实是 v13", _Q == "quality-v13", _Q)
...
def test_v6_pool_quarantines_quality_v5():
    ...
    ok2, why2 = PuzzlePool._validate_pool_spec(_full(QUALITY_POLICY_VERSION))
    check("当前 policy 完整题 -> 入池", ok2, why2)
